...
export function sanitizePublicDetails(value: Record<string, unknown>): Record<string, unknown> {
  return JSON.parse(JSON.stringify(value, (_key, item) => {
    ...
    return item
      ...
      .replace(/\b(?:native_session_id|native_session|native_error|native_path|native_url|credential_material|raw_credential|api_key|password|token|session_id|file_path|path|url|provider_agent|provider_task|provider_cancel)\b/gi, "[redacted-field]");
