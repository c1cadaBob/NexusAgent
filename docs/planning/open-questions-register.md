...
| OQ-INFRA-002 | 已关闭 | 基础设施 | Event Bus 生产底层选型是什么。 | P1 结束前，P8 发布前复核。 | 平台内核/SRE。 | `docs/planning/open-questions/P1-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/backup-restore.md`。 |
| OQ-INFRA-003 | 已关闭 | 基础设施 | Artifact Store 生产对象存储和备份策略是什么。 | P1 结束前，P8 发布前复核。 | 平台内核/SRE/安全。 | `docs/planning/open-questions/P1-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/backup-restore.md`。 |
| OQ-INFRA-004 | 已关闭 | 基础设施 | Credential Center 生产密钥后端是什么。 | P1 结束前，P8 发布前复核。 | 安全/SRE/平台内核。 | `docs/planning/open-questions/P1-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/backup-restore.md`。 |
| OQ-INFRA-005 | 已关闭 | 基础设施 | Observability 生产后端和告警标准是什么。 | P1 结束前，P8 发布前复核。 | SRE/平台内核/安全。 | `docs/planning/open-questions/P1-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/observability-alerts.md`。 |
...
| OQ-MEMORY-002 | 已关闭 | Memory Gateway | Memory Gateway 生产检索和存储选型是什么。 | P3 前，P8 发布前复核。 | 平台内核/SRE/Hermes。 | `docs/planning/open-questions/P3-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/backup-restore.md`。 |
...
| 问题ID | 状态 | 分类 | 问题描述 | 最晚确认阶段 | 负责人/工作流 | 解决说明文档 |
| --- | --- | --- | --- | --- | --- | --- |
| OQ-BUDGET-001 | 自动确认 | 资源预算 | Token 预算按租户、用户、Agent 还是任务计费。 | P7-04 前。 | 平台/产品/评测。 | `docs/planning/open-questions/P7-resolution-plan.md`。 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| OQ-UPSTREAM-001 | 自动确认 | 上游版本 | `vendor/MANIFEST.yaml`、`docs/architecture/upstream-interface-inventory.md`、`docs/risks/risk-register.md`。 | Hermes 真实 Git remote、release commit 和 fork 分支是什么。 | 影响 provider 兼容矩阵、补丁回滚、许可证追踪和上游升级判断。 | 上游改造。 | P3 前。 | P8-02 未从当前 vendor manifest 确认真正 upstream remote/commit，默认处理为 `upstream_identity_unconfirmed`；`config/provider-compatibility.p8.json` 固定 `hermes-0.20.5` current default、tree sha、required tests、canary-first 和 `rollback_target`，`weekly-upstream-check.mjs` 输出 `UPSTREAM_IDENTITY_UNCONFIRMED` 并阻止 production default promotion。 | `docs/planning/open-questions/P3-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/provider-plugin-compatibility.md`。 | REQ-019/R-016。 | P8-02 补 provider compatibility matrix、optional remote upstream check 和 release pause 证据；真实 upstream identity 仍需后续 upstream change record 或人工来源确认。 | 2026-08-28。 |
| OQ-UPSTREAM-002 | 自动确认 | 上游版本 | `vendor/MANIFEST.yaml`、`docs/decisions/P0-openclaw-gateway-only.md`、`docs/risks/risk-register.md`。 | OpenClaw 真实 Git remote、release commit 和 fork 分支是什么。 | 影响 gateway provider 升级、渠道插件兼容和 P4 强制模式评审。 | 上游改造/渠道。 | P4 前。 | P8-02 未从当前 vendor manifest 确认真正 upstream remote/commit，默认处理为 `upstream_identity_unconfirmed`；`config/provider-compatibility.p8.json` 固定 `openclaw-2026.8.1` current default、tree sha、required tests、canary-first 和 `rollback_target`，上游未知会触发 release pause。 | `docs/planning/open-questions/P4-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/provider-plugin-compatibility.md`。 | REQ-019/R-016。 | P8-02 补 provider compatibility matrix、optional remote upstream check 和 release pause 证据；真实 upstream identity 仍需后续 upstream change record 或人工来源确认。 | 2026-08-28。 |
| OQ-UPSTREAM-003 | 自动确认 | 上游版本 | `vendor/MANIFEST.yaml`、`docs/architecture/dsh-versioning-and-replacement.md`、`docs/risks/risk-register.md`。 | DSH 真实 Git remote、release commit 和 fork 分支是什么。 | 影响 executor provider 固定、替换、回滚和预览版变更追踪。 | 上游改造/执行器。 | P2 前。 | P8-02 未从当前 vendor manifest 确认真正 upstream remote/commit，默认处理为 `upstream_identity_unconfirmed`；`config/provider-compatibility.p8.json` 固定 `dsh-0.1.1-rc.2` current default、tree sha、required tests、canary-first 和 `rollback_target`，上游未知会触发 release pause。 | `docs/planning/open-questions/P2-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/provider-plugin-compatibility.md`。 | REQ-018/R-001/R-016。 | P8-02 补 provider compatibility matrix、optional remote upstream check 和 release pause 证据；真实 upstream identity 仍需后续 upstream change record 或人工来源确认。 | 2026-08-28。 |
...
| OQ-INFRA-004 | 已关闭 | 基础设施 | `docs/architecture/service-blueprint.md`、`docs/planning/development-schedule.md`。 | Credential Center 生产密钥后端是什么。 | 影响凭据轮换、动态租约、审计、最小权限和明文泄漏测试。 | 安全/SRE/平台内核。 | P1 结束前，P8 发布前复核。 | 接受 P8-03 默认生产后端：Vault；备份恢复只保存 `credential_ref`、purpose、lease metadata、redaction metadata 和 material hash continuity marker，不导出凭据值。 | `docs/planning/open-questions/P1-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/backup-restore.md`、`docs/operations/incident-restore-drill.md`。 | REQ-013/R-014。 | P8-03 本次提交补 credential reference-only restore gate、secret isolation test 和 backup config；最终 commit hash 见完成报告。 | 2026-08-29。 |
| OQ-INFRA-005 | 已关闭 | 基础设施 | `docs/architecture/service-blueprint.md`、`docs/planning/development-schedule.md`。 | Observability 生产后端和告警标准是什么。 | 影响 trace 存储、日志保留、指标命名、告警接入和控制台监控页。 | SRE/平台内核/安全。 | P1 结束前，P8 发布前复核。 | 接受 P8-03 默认生产后端：OpenTelemetry + Prometheus/Loki/Tempo；告警目录覆盖 API availability、task failure rate、adapter degradation、event backlog/DLQ、artifact checksum、credential lease、memory anomalies、backup freshness 和 restore drill status。 | `docs/planning/open-questions/P1-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/observability-alerts.md`。 | REQ-013/R-008。 | P8-03 本次提交补 `nexus.observability_readiness.p8.v1`、alert catalog validator、runbooks 和 P8 smoke；最终 commit hash 见完成报告。 | 2026-08-29。 |
| OQ-INFRA-006 | 自动确认 | 基础设施 | `docs/architecture/service-blueprint.md`。 | 长任务编排是否引入 Temporal/Cadence 或继续自研状态机。 | 影响恢复、人工信号、重试、补偿事务和部署复杂度。 | 平台内核/SRE/架构。 | P6 前。 | P6-01 接受默认 TaskState/Coordinator 路线：基础业务闭环已用 deterministic in-process E2E 证明同一 Coordinator、Policy-Gate、Event Bus、Memory Gateway、Artifact Store 和内部 adapters 可串联；P6-02 安全矩阵继续验证跳过审批/预算、伪造 Policy-Gate/trusted header、disabled/unknown provider 和直接 adapter invoke 均由 Coordinator/Policy-Gate fail closed 并保留 denied evidence；P6-03 fault injection matrix 证明 Hermes disabled 时 seeded platform plan lightweight route 可完成基础任务，DSH canary throw/timeout/resource exhaustion/破坏性返回、duplicate events dead-letter、memory conflict、provider rollback 和 Docker Compose dev lifecycle drill 均由平台状态机与恢复策略承接。 | `docs/planning/open-questions/P6-resolution-plan.md`。 | REQ-011/R-008/REQ-010。 | P6-01/P6-02/P6-03 补闭环、安全矩阵、故障恢复和降级路线证据；Temporal/Cadence、生产 durable workflow 和发布运维手册仍待 P8。 | 2026-08-26。 |
| OQ-MEMORY-001 | 自动确认 | Memory Gateway | `docs/planning/integrated-platform-plan.md`、`docs/architecture/service-blueprint.md`、`docs/decisions/P0-hermes-planner-only.md`。 | Hermes Memory Gateway 的五层记忆具体层级、保留期和冲突策略是什么。 | 影响 P3 planner context、并发写入、快照、冲突解决和审计。 | 平台内核/Hermes/产品。 | P3 前。 | P3-02/P3-04 已补三层 planner snapshot、expected_version 冲突和防直读证据；P7-02 补默认启用 conservative retention、session 7 天 manual sweep soft delete、长期层默认保留、audit_snapshot immutable、metadata-only delete/sweep audit 和不可跨租户误删证据；P7-04 补默认启用 `nexus.memory_conflict.p7.v1` conflict detection、Admin resolve queue 和 metadata-only conflict decision 证据。 | `docs/planning/open-questions/P3-resolution-plan.md`、`docs/planning/task-prompts/P7/P7-02.md`、`docs/planning/task-prompts/P7/P7-04.md`。 | REQ-008/R-005。 | P7-02 补保留期/soft delete/过期审计证据；P7-04 补 expected_version mismatch 的管理员冲突队列证据；生产存储、检索、备份和物理清除策略仍由 `OQ-MEMORY-002` 与 P8 继续复核。 | 2026-08-27。 |
| OQ-MEMORY-002 | 已关闭 | Memory Gateway | `docs/architecture/service-blueprint.md`、`docs/risks/risk-register.md`。 | Memory Gateway 生产检索和存储选型是什么。 | 影响检索延迟、一致性、租户隔离、备份和运维复杂度。 | 平台内核/SRE/Hermes。 | P3 前，P8 发布前复核。 | 接受 P8-03 默认生产后端：PostgreSQL + pgvector；Memory Gateway 继续保持 tenant partition、versioned writes、conflict queue、retention sweep 和 point-in-time restore 语义，恢复报告只包含 metadata，不保存 rejected memory text。 | `docs/planning/open-questions/P3-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/backup-restore.md`、`docs/operations/incident-restore-drill.md`。 | REQ-008/REQ-013/R-005/R-008。 | P8-03 本次提交补 memory version continuity gate、conflict metadata restore gate、backup profile 和 leakage tests；最终 commit hash 见完成报告。 | 2026-08-29。 |
| OQ-DSH-001 | 自动确认 | DSH 执行器 | `docs/architecture/dsh-versioning-and-replacement.md`、`docs/risks/risk-register.md`。 | DSH 预览版是否固定为当前 `0.1.1-rc.2` provider，后续如何并存、禁用和回滚。 | 影响 P2 provider registry、兼容 fixture、升级门禁和生产默认 executor 切换。 | 上游改造/执行器/SRE。 | P2 前。 | P2-01/P2-04 已固定当前默认 provider 并验证 provider registry、禁用、失败 canary 和 rollback；P6-03 补 DSH canary throw、timeout、resource exhaustion、破坏性返回清洗和 `rollbackDefault()` 恢复证据；P8-02 将 `dsh-0.1.1-rc.2` 纳入 provider compatibility matrix，默认 promotion 策略为 `canary_first`，生产 default 切换需通过 release gate 且保留 `rollback_target`。 | `docs/planning/open-questions/P2-resolution-plan.md`、`docs/planning/open-questions/P6-resolution-plan.md`、`docs/planning/open-questions/P8-resolution-plan.md`、`docs/operations/provider-plugin-compatibility.md`。 | REQ-018/R-001/R-016。 | P2/P6/P8-02 已补 provider 并存、禁用、回滚、升级矩阵和发布门禁证据；正式 sandbox 后端和 OS 级隔离仍待 P8-04。 | 2026-08-28。 |
