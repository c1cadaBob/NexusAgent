...
- 遗留风险：P3-02 不证明真实跨进程 Memory Gateway transport、生产数据库/向量检索、保留期、sidecar 文件权限或完整 Plugin Bridge 白名单；这些继续由 P3-03/P3-04/P6/P8 关闭。
