...
## P4-01 OpenClaw gateway-only provider 边界更新
...
- 遗留风险：P4-01 不实现完整 IM/WebSocket payload 映射、出站回写、继续/重做/取消语义、真实 sidecar 网络策略或插件升级矩阵；这些继续由 P4-02/P4-03/P4-04/P6/P8 关闭。
