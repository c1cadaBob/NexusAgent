...
## P4-01/P4-02 OpenClaw gateway-only provider 与 channel 防腐更新
...
- 遗留风险：P4-02 不实现真实 IM/WebSocket 厂商发送、流式输出、继续/重做/取消完整语义、真实 sidecar 网络策略或插件升级矩阵；这些继续由 P4-03/P4-04/P5/P6/P8 关闭。
