...
export default {
  ...
  setup: {
    ...
    descriptions: {
      bootstrap: 'Enter the installation code to unlock the setup session.',
      admin: 'Create the first super admin account for this profile.',
      model: 'Choose the provider, model, and credentials for the default profile.',
      gateway: 'Enable or skip message gateways such as Telegram, Discord, and Slack.',
      validate: 'Check that the administrator, model, and gateway settings are usable.',
      complete: 'Write the final state and move into the chat workspace.',
    },
    stateLabel: 'State',
    ...
    migration: {
      fresh: 'Fresh install',
      'legacy-users': 'Existing users were found. Model setup is still required.',
      'legacy-model': 'A usable model was found. Administrator setup is still required.',
      'legacy-ready': 'Existing users and a usable model were found. Setup will finish automatically.',
    },
    ...
    adminPasswordPlaceholder: 'Create a password',
    provider: 'Provider',
    ...
    baseUrlHelp: 'Leave this blank to use the provider default endpoint.',
    apiKey: 'API key',
    apiKeyPlaceholder: 'Enter the provider key if needed',
    gatewayEnable: 'Enable gateway platforms',
    gatewayHelp: 'Skip this step to keep gateway platforms disabled for now.',
    platforms: 'Platforms',
    morePlatforms: 'More platforms',
    skipGateway: 'Skip gateway',
    validate: 'Validate setup',
    completeTitle: 'Setup is ready',
    completeBody: 'The administrator, model, and optional gateway settings are saved. You can enter chat now.',
    enterChat: 'Enter chat',
    completeSuccess: 'Setup completed successfully',
  },
