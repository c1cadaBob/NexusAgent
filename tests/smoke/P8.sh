...
echo 'PASS: P8-01/P8-02 production orchestration, release gate, GHCR candidate publish, canary rollback, upstream tracking, compatibility matrix, static isolation, and smoke checks'
