...
- `P5.sh`：检查 P5-01 平台 REST API、P5-02 Web 控制台、OpenAPI runtime alignment、管理员插件治理投影、P5-01/P5-02 审计记录、产品 API/控制台上游术语泄漏防护、P5 targeted contract/integration/security tests 和 Vite build。
