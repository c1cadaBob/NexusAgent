...
- `P5.sh`：检查 P5-01 平台 REST API、P5-02 Web 控制台、P5-03 渠道接入管理、OpenAPI runtime alignment、管理员插件治理投影、P5-01/P5-02/P5-03 审计记录、产品 API/控制台/渠道管理上游术语泄漏防护、P5 targeted contract/integration/security tests 和 Vite build。
