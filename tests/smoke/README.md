...
- `P4.sh`：检查 OpenClaw gateway-only provider registry、channel anti-corruption adapter、Plugin Bridge 白名单与 ClawHub/npm inventory、vendor guard、P4-01/P4-02 审计记录、dev/prod 端口隔离和公共泄漏防护。
