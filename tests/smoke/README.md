...
每个阶段提供 `P<阶段号>.sh` 一键脚本，脚本必须输出可读的 `PASS` 或 `FAIL`，并检查该阶段的核心产物、依赖连通性和关键接口。P0/P1/P2/P3/P4/P5 脚本已随阶段任务交付；P6-P8 随各阶段继续补齐。
...
- `P5.sh`：检查 P5-01 平台 REST API、P5-02 Web 控制台、P5-03 渠道接入管理、P5-04 TypeScript SDK 和开发者文档站、OpenAPI runtime alignment、管理员插件治理投影、P5-01/P5-02/P5-03/P5-04 审计记录、产品 API/控制台/渠道管理/SDK/docs 上游术语泄漏防护、P5 targeted contract/integration/security tests、SDK/docs examples 和 Vite build。
